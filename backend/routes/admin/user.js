...
users.get("/users", [userMiddleware.getusers, authUserMiddleware], userService.getUsers);
...
users.delete("/users/:id", [userMiddleware.deleteUser, authUserMiddleware], userService.deleteUser); 
